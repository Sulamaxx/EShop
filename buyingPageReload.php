...
<table class="col-12">
    ...
    $result = Database::search("
                        ...
                        INNER JOIN brand ON model_has_brand.brand_id=brand.id ORDER BY invoice.id DESC
                        ");
    $n = $result->num_rows;
    $total = 0;
    ...
    ?>
        ...
        <span onload="" class="col-12 p-2 border-right position-absolute fs-2 fw-bold text-center" style="margin-top:300px;">Empty Buying History</span>
        <span class="col-12 fs-2 position-absolute" id="totalBuyingPrice" hidden><?php echo $total; ?></span>
